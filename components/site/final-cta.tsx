...
const floatingPhotos = [
  { src: '/images/wedding-dance.png', alt: 'Esküvői tánc', className: 'left-[4%] top-[18%] w-24 rotate-[-8deg] sm:w-28' },
  { src: '/images/birthday.png', alt: 'Születésnap', className: 'right-[6%] top-[12%] w-24 rotate-[7deg] sm:w-32' },
  { src: '/images/group-lookout.png', alt: 'Csoportkép', className: 'left-[8%] bottom-[14%] w-24 rotate-[6deg] sm:w-28' },
  { src: '/images/garden-party.png', alt: 'Kerti buli', className: 'right-[5%] bottom-[16%] w-24 rotate-[-6deg] sm:w-32' },
]
      ...
      <div className="mx-auto max-w-6xl">
        <Reveal>
          <div className="glass-strong relative overflow-hidden rounded-[2.5rem] px-6 py-20 text-center sm:px-10 sm:py-28">
            ...
            >
              <div className="absolute left-1/2 top-1/2 h-96 w-96 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(150,120,255,0.22),transparent_70%)] blur-3xl" />
              <QrCode className="absolute left-1/2 top-1/2 size-[26rem] -translate-x-1/2 -translate-y-1/2 text-white/[0.03]" strokeWidth={0.5} />
            </div>
            ...
            <div aria-hidden="true" className="pointer-events-none absolute inset-0 hidden sm:block">
              {floatingPhotos.map((p, i) => (
                <div
                  key={p.src}
                  className={`glass animate-float-slow absolute overflow-hidden rounded-2xl p-1 ${p.className}`}
